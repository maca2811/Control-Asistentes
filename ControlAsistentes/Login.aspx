<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="ControlAsistentes.Login" %>
                    ...
                    <div class="loginOutline col-xs-12">
                        ...
                        <div class="panel-heading">
                            <div class="panel-title text-center">
                                <h3 style="font-family: 'Bookman Old Style'"><strong>Bienvenido</strong></h3>
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                            ...
                            <label style="font-family: 'Bookman Old Style'" for="exampleInputEmail1">Usuario</label>
                            ...
                            <label style="font-family: 'Bookman Old Style'" for="exampleInputPassword1">Contraseña </label>
                            <div class="input-group">
                            ...
                            <div class="loginButton">
                                <asp:LinkButton ID="btIngresar" runat="server" CssClass="btn btn-default boton-main btn-lg" CausesValidation="False" UseSubmitBehavior="False" Font-Names="Bookman Old Style" OnClick="btnIngresar_Click2">
                                        Iniciar Sesión
